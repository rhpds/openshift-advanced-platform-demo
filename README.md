# openshift-advanced-platform-demo

An exact copy of the https://catalog.demo.redhat.com/catalog/babylon-catalog-prod?item=babylon-catalog-prod/published.ocp4-adv-app-platform-demo.prod demo CI. The goal of the lab is attendee enablement on this CI and how to effectively demo it.

**Owner:** markusjnagel
**Migrated from:** https://github.com/rhpds/adv-app-platform-demo-showroom
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/openshift-advanced-platform-demo`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/openshift-advanced-platform-demo
   ```
3. `cd openshift-advanced-platform-demo`
