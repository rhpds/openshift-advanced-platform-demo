...
----
+
* `200`. "Same governed endpoint as Section 1, now with a key that this developer requested, that this owner approved, on a plan the platform enforces."
...
* The plan (silver) is enforced by the gateway from the moment of approval; changing plans is an approval, not a configuration change
